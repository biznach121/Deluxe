...
export const brand: Brand = {
  name: "Deluxe Nails & Spa",
  shortName: "Deluxe",
  microTag: "REJUVENATE. RELAX. REPEAT.",
  description:
    "Deluxe Nails & Spa is a Accra beauty studio where treatments, care and calm come together under one roof.",
  ...
  contact: {
    ...
    countryCode: "GH",
    phone: "0500941064",
    phoneTel: "+233500941064",
    textPhone: "0500941064",
    textPhoneTel: "+233500941064",
    email: "hello@deluxe.test",
    privacyEmail: "privacy@deluxe.test",
    hours: "Call or text to book",
  },

  socials: [
    { label: "TikTok", href: "https://www.tiktok.com/@deluxe.nails.spa1", icon: "tiktok" },
  ],
  ...
  editorial: {
    ...
    notes: [
      ...
      {
        body: "Deluxe Nails & Spa exists so that slowing down doesn't cost you your rhythm. One hour here gives back more than it takes — a genuine reset with a visible result.",
    ...
    images: [
      {
        ...
        alt: "Deluxe Nails & Spa beauty treatment detail",
      ...
      },
      {
        ...
        alt: "Deluxe Nails & Spa self-care treatment",
        className: "right-[5%] top-[15%] h-[255px] w-[155px] rounded-[999px]",
        sizes: "155px",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/image/upload/v1780682215/yqkj1i8lrp7m9zmlze4z.jpg",
        alt: "Deluxe Nails & Spa beauty ritual",
      ...
      },
      {
        ...
        alt: "Deluxe Nails & Spa calm care moment",
        className: "right-[6%] top-[68%] h-[145px] w-[100px] rounded-[999px]",
        sizes: "100px",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/image/upload/v1780682215/yqkj1i8lrp7m9zmlze4z.jpg",
        alt: "Deluxe Nails & Spa relaxation detail",
        className: "left-[25%] top-[75%] h-[150px] w-[102px] rounded-[999px]",
        sizes: "102px",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/image/upload/v1780682215/bgkgjrchbkhtckgh9f7t.jpg",
        alt: "Deluxe Nails & Spa beauty and peace detail",
    ...
    items: [
      {
        ...
        imageAlt: "Deluxe Nails & Spa lip gloss product",
        tone: "light",
      },
      {
        name: "mint\nbeauty oil",
        ...
        imageAlt: "Deluxe Nails & Spa mint oil product",
        tone: "olive",
      },
      {
        name: "brush\nessentials",
        ...
        imageAlt: "Deluxe Nails & Spa makeup brush set",
        tone: "light",
      },
      {
        name: "smooth\nfoundation",
        ...
        imageAlt: "Deluxe Nails & Spa foundation product",
        tone: "olive",
      },
    ],
  },
  ...
  about: {
    eyebrow: "About Deluxe Nails & Spa",
    title: "Your sanctuary\nof beauty and peace.",
    paragraphs: [
      "Deluxe Nails & Spa is a curated beauty and self-care space in Accra, created for the moments when you want to feel polished, calm, and cared for without rushing through the process.",
    ...
    sections: [
      ...
      {
        heading: "Visit",
        body: "Find us in Accra. Use the Location page for the exact Google Maps pin, or call 0500941064 and text 0500941064 for booking help.",
      },
    ],
  },
  ...
  faq: {
    ...
    sections: [
      {
        ...
        items: [
          { q: "How do I book?", a: "Use the Book page, call 0500941064, text 0500941064, or message @deluxe.nails.spa1 on Instagram." },
          ...
          { q: "Where are you located?", a: "Deluxe Nails & Spa is in Accra. The Location page has the exact Google Maps pin." },
        ],
      },
      {
        title: "Treatments",
    ...
    contactEmail: "hello@deluxe.test",
  },
  ...
  terms: {
    ...
    sections: [
      { heading: "1. Who we are", body: "Deluxe Nails & Spa (\"we\", \"us\") is a beauty and self-care business in Accra, Ghana. By booking a service or buying a product, you agree to these terms." },
  ...
  privacy: {
    ...
    sections: [
      ...
      { heading: "Your rights", body: "Under the Ghana Data Protection Act, 2012 (Act 843), you can access, correct, or delete your data. Email privacy@deluxe.test." },
  ...
  shipping: {
    ...
    sections: [
      ...
      { heading: "Location", body: "Deluxe Nails & Spa is in Accra. Visit the Location page for the exact Google Maps pin." },
  ...
  accessibility: {
    ...
    sections: [
      ...
      { heading: "Reporting issues", body: "Email accessibility@deluxe.test, call, or text the studio. We respond within a business day." },
    ],
  },

  account: {
    loginEyebrow: "Welcome back",
    loginTitle: "Sign in to Deluxe Nails & Spa",
  ...
  contactPage: {
    ...
    directLines: [
      { label: "Call", value: "0500941064", href: "tel:+233500941064" },
      { label: "Text", value: "0500941064", href: "sms:+233500941064" },
      { label: "Instagram", value: "@deluxe.nails.spa1", href: "https://www.tiktok.com/@deluxe.nails.spa1" },
    ],
  },
  ...
  footer: {
    blurb:
      "Deluxe Nails & Spa in Accra — rejuvenate. relax. repeat..",
    sitemap: [
      {
        title: "Visit",
        links: [
          ...
          { label: "Location", href: "/location" },
          { label: "Instagram", href: "https://www.tiktok.com/@deluxe.nails.spa1" },
        ],
      },
      {
        title: "Studio",
      ...
      },
      {
        ...
        links: [
          ...
          { label: "Call 0500941064", href: "tel:+233500941064" },
          { label: "Text 0500941064", href: "sms:+233500941064" },
        ],
      },
      {
        title: "Account",
  ...
  llms: {
    summary:
      "Deluxe Nails & Spa — beauty and self-care in Accra. Lashes, brows, nails, pedicure, waxing, piercing, facials, massage, and beauty products. Booking via website, call, text, or Instagram.",
  },
