...
export function Hero({
  ...
  return (
    <section className="spa-video-hero relative isolate h-[95svh] min-h-[620px] overflow-hidden rounded-b-[28px] bg-[#70224b] text-white lg:rounded-b-[36px]">
      {heroVideos.length > 0 ? (
        ...
        <div className="absolute inset-0 -z-20 bg-[#7d2859]" />
      )}
      <div className="absolute inset-0 -z-10 bg-[linear-gradient(90deg,rgba(73, 16, 48,0.58),rgba(97, 13, 69,0.22)_43%,rgba(75, 21, 50,0.34)),linear-gradient(0deg,rgba(39, 12, 26,0.18),rgba(39, 12, 26,0.08))]" />
