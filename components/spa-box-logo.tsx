...
const LOGO_URL =
  "https://res.cloudinary.com/dzykdnbvb/raw/upload/v1783494505/stage4/spa_deluxenailsspa1/logo.svg";
...
export function SpaBoxLogo({ className = "", compact = false, tone = "light" }: SpaBoxLogoProps) {
  ...
  if (REAL_LOGO) {
    ...
    return (
      <span className={["relative inline-block", sizeClass, className].join(" ")} aria-label="Deluxe Nails & Spa - Rejuvenate. Relax. Repeat.">
        <Image
          src={src}
          alt="Deluxe Nails & Spa - Rejuvenate. Relax. Repeat."
          fill
